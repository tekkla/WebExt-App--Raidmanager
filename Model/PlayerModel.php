...
final class PlayerModel extends Model
{
    ...
    public function addActionbar($player)
    {
        if ($this->checkAccess('raidmanager_perm_player'))
        {
            ...
            // the edit button
            $actionbar->createButton('edit', 'ajax', 'icon')->setRoute('raidmanager_player_edit', array(
                'id_player' => $player->id_player
            ));

            // the delete button
            $actionbar->createButton('delete', 'ajax', 'icon')->setRoute('raidmanager_player_delete', array(
                'id_player' => $player->id_player
            ));
